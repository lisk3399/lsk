...
class TLSSigAPI {
     ...
     * @return string 生成的UserSig 失败时为false 180*24*3600=15552000
     */
    ...
    public function signature($identifier, $sdkappid, $private_key_path) {
        $command = '/usr/local/tools/bin/signature'
