...
namespace User\Apixb;
use User\Apixb\Api;
use User\Modeli\UcenterMemberModel;
...
class UserApi extends Api{
    ...
    protected function _init(){
        $this->modeli = new UcenterMemberModel();
    }
    ...
    public function register($mobile, $password, $repassword, $verify, $platform, $device_id){
        $this->modeli->register($mobile, $password, $repassword, $verify, $platform, $device_id);var_dump($this);exit;
    }
    ...
    public function login($username, $password){
        return $this->modeli->login($username, $password);
    }
